...
class TextWithExponent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Row(children: <Widget>[
      new Text(text, style: new TextStyle(fontSize: textSize, color: Colors.white),),
      new Container(
        child: new Text(exponentText, style: new TextStyle(fontSize: exponentTextSize, color: Colors.white)),
